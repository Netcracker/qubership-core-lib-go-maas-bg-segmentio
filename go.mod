...
require (
	...
	github.com/netcracker/qubership-core-lib-go-bg-kafka/v3 v3.4.6
	github.com/netcracker/qubership-core-lib-go-bg-state-monitor/v2 v2.5.6
	github.com/netcracker/qubership-core-lib-go-maas-client/v3 v3.4.6
	github.com/netcracker/qubership-core-lib-go-maas-segmentio/v3 v3.4.6
